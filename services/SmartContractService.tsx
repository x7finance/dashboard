...
//     x7105: this.x7105,
//   };
//   migrationContract = new this.web3.eth.Contract(
//     abis.MigrationContractABI,
//     Addresses.MigrationContract
//   );
...
//     contract.methods
//       .balanceOf(address)
//       .call(function (err: any, balance: BigInt) {
//         if (err) {
//           error();
//           console.error(err);
//           return;
...
//   async getUserMigrationStatus(
//     tokenName: string,
//     tokenAddress: string,
//     address: string
//   ): Promise<UserMigrationStatusResponse> {
//     const status = await this.migrationContract.methods
//       .isAv1TokenHolder(tokenAddress, address)
//       .call();
...
//     this.migrationContract.methods
//       .postMigration()
